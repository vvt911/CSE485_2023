            ...
            <div class="col-sm">
                ...
                <form action="process_edit_article.php" method="post" enctype="multipart/form-data">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtMaBaiViet" value="<?php echo $article['ma_bviet']; ?>" readonly>
                    </div>
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <textarea class="form-control" name="txtNoiDung" rows="10"><?php echo $article['noidung']; ?></textarea>
                    </div>
